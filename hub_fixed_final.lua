...
local _gs = function(s) local ok,r = pcall(function() return game:GetService(s) end); return ok and r or nil end
local Services = {
    Players            = _gs("Players"),
    RunService         = _gs("RunService"),
    UserInputService   = _gs("UserInputService"),
    ReplicatedStorage  = _gs("ReplicatedStorage"),
    TweenService       = _gs("TweenService"),
    HttpService        = _gs("HttpService"),
    Workspace          = _gs("Workspace"),
    Lighting           = _gs("Lighting"),
    VirtualInputManager= _gs("VirtualInputManager"),
    GuiService         = _gs("GuiService"),
    TeleportService    = _gs("TeleportService"),
}
...
local function loadSideTP()
    ...
    pcall(function()
        ...
        local _ENV = getfenv()
        -- Side TP placeholder removed (add real URL here)
        local _stp = nil
